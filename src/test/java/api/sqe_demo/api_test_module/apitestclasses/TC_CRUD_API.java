...
import api.sqe_demo.api_test_module.apipageclasses.API_POSTDataset;
import api.sqe_demo.api_test_module.apipageclasses.API_GETDataset;
import api.sqe_demo.api_test_module.apipageclasses.API_PUTDataset;
import api.sqe_demo.api_test_module.apipageclasses.API_DELETEDataset;
public class TC_CRUD_API extends BaseClass {
	...
	public void doRequest() throws Exception { 
		...
		String primaryInfo = API_DELETEDataset.primaryInfo;
		Constants.PRIMARY_INFO = primaryInfo;
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath ,API_DELETEDataset.projectName);
		int datasetLength = API_DELETEDataset.datasetLength; 
